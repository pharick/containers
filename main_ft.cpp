...
template<typename T>
void print_list_reverse(const ft::list<T> &lst) {
    typename ft::list<T>::const_reverse_iterator it;
...
void print_map(const ft::map<Key, T> &mp) {
...
template<typename Key, typename T>
void print_map_reverse(const ft::map<Key, T> &mp) {
    typename ft::map<Key, T>::const_reverse_iterator it;
...
template<typename T>
void print_stack(const ft::stack<T> st) {
    ft::stack<T> st1 = st;
    while (!st1.empty()) {
        std::cout << st1.top() << " ";
        st1.pop();
...
template<typename T>
void print_set(const ft::set<T> st) {
...
template<typename T>
void print_set_reverse(const ft::set<T> st) {
    typename ft::set<T>::const_reverse_iterator it;
...
void list_test() {
     ...
     * Fill constructor
     */
    ft::list<std::string> lst2(7, "hello");
    print_list(lst2);

     /**
      * Range constructor
      */
    ft::list<std::string>::iterator lst2_it1 = lst2.begin();
    ft::list<std::string>::iterator lst2_it2 = lst2.end();
    lst2_it1++;
    lst2_it2--;
    lst2_it2--;
    ft::list<std::string> lst3(lst2_it1, lst2_it2);
    print_list(lst3);

    /**
     * Copy constructor
     */
    ft::list<std::string> lst4(lst3);
    print_list(lst4);
    ...
    *lst2_it1 = "bazinga";
    print_list(lst2);
//    ft::list<std::string>::const_iterator lst2_const_it = lst2_it1;
//    *lst2_const_it = "what?!";
    ...
    *lst2_it2 = "qq";
    print_list(lst2);
//    ft::list<std::string>::const_iterator lst2_const_it2 = lst2_it2;
//    *lst2_const_it2 = "wtf?!";

    /**
     * rbegin
     */
    ft::list<std::string>::reverse_iterator lst2_rev_it1 = lst2.rbegin();
    std::cout << *lst2_rev_it1 << std::endl;
    lst2_rev_it1++;
    *lst2_rev_it1 = "wine";
    print_list(lst2);
    ft::list<std::string>::const_reverse_iterator lst2_const_rev_it1 = lst2_rev_it1;
//    *lst2_const_rev_it1 = "nope";
     ...
     * rend;
     */
    ft::list<std::string>::reverse_iterator lst2_rev_it2 = lst2.rend();
    lst2_rev_it2--;
    std::cout << *lst2_rev_it2 << std::endl;
    lst2_rev_it2--;
    *lst2_rev_it2 = "cplusplus";
    print_list(lst2);
    ft::list<std::string>::const_reverse_iterator lst2_const_rev_it2 = lst2_rev_it2;
//    *lst2_const_rev_it2 = "ahaha!";
     ...
     * back
     */
     const ft::list<int> &lst1_ref = lst1;
//     lst1_ref.back() = 999;
     ...
     * insert
     */
    ft::list<int>::iterator lst1_it1 = lst1.begin();
    lst1_it1++;
    lst1_it1++;
    ...
    ft::list<int>::iterator lst5_it1 = lst5.begin();
    lst5_it1++;
    ft::list<int>::iterator lst5_it2 = lst5_it1;
    lst5_it2++;
    lst5_it2++;
    lst5_it2++;
    lst5_it2++;
    ...
    ft::list<int>::const_iterator lst1_const_it1 = lst1.begin();
...
void vector_test() {
    ...
    ft::vector<int> vct3(lst1.begin(), lst1.end());
    print_vector(vct3);

    ft::vector<int> vct4(vct3.begin(), vct3.end());
    print_vector(vct4);
...
void map_test() {
    ...
    ft::pair< ft::map<int, std::string>::const_iterator, bool > ins_res;
    for (int i = 0; i < 6; i++) {
        ins_res = mp1.insert(ft::make_pair(keys[i], values[i]));
        if (ins_res.second)
     ...
     * Range constructor
     */
    ft::vector< ft::pair<int, std::string> > vct;
    vct.push_back(ft::make_pair(4, "hello"));
    vct.push_back(ft::make_pair(7, "how"));
    vct.push_back(ft::make_pair(4, "you"));
    vct.push_back(ft::make_pair(3, "are"));
    vct.push_back(ft::make_pair(6, "doing"));

    ft::map<int, std::string> mp2(vct.begin(), vct.end());
    print_map(mp2);

    /**
     * Copy constructor
     */
    ft::map<int, std::string> mp3(mp2);
    print_map(mp3);

    /**
     * Copy container content
     */
    ft::map<int, std::string> mp4 = mp3;
    print_map(mp4);
    ...
    mp1.insert(ft::make_pair(30, "i see you"));
    print_map(mp1);
    std::cout << mp1.size() << std::endl;
    ...
    mp2.insert(ft::make_pair(10, "gigigigi"));
    print_map(mp1);
    print_map(mp2);
    ...
    ft::map<int, std::string>::const_iterator fi;
    for (int i = 0; i < 4; i++) {
        fi = mp1.find(fkeys[i]);
        if (fi != mp1.end())
    ...
    ft::map<char, int>::iterator it = mp5.lower_bound('e');
    if (it == mp5.end())
     ...
     */
    print_map(mp2);
    ft::pair<ft::map<int, std::string>::const_iterator, ft::map<int, std::string>::const_iterator> p = mp2.equal_range(5);
    ft::map<int, std::string>::const_iterator it1;
...
void set_test() {
    ...
    ft::set<float> st2(vct.begin(), vct.end());
    print_set(st2);

    /**
     * Copy constructor
     */
    ft::set<float> st3(st2);
    print_set(st3);
     ...
     * equal range
     */
    ft::pair<ft::set<float>::iterator, ft::set<float>::iterator> range;
    range = st1.equal_range(5.47);
    for (ft::set<float>::iterator it1 = range.first; it1 != range.second; it1++) {
        std::cout << *it1 << " ";
    }
    std::cout << std::endl;
